...
export class Backend implements backendInterface {
    ...
    async getChatMessages(arg0: string, arg1: number): Promise<Array<ChatMessage>> {
        if (this.processError) {
            try {
                const result = await (this.actor as any).getChatMessages(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRoomState(arg0: string): Promise<Array<PlayerState>> {
        if (this.processError) {
            try {
    ...
    async submitScore(arg0: string, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updatePlayerState(arg0: string, arg1: string, arg2: number, arg3: number, arg4: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePlayerState(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
